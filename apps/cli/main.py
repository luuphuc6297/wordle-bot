...
@app.command()
def benchmark(
  games: int = typer.Option(100, "--games", "-g", help="Number of games for benchmark"),
...
def analytics(
  ...
  sample_size: int = typer.Option(20, "--sample-size", help="Sample size for analysis"),
):
  ...
  try:
    ...
    if analysis_type == "difficulty":
      result = {
        ...
        "results": analytics_engine.analyze_word_difficulty(sample_size=sample_size),
      }
