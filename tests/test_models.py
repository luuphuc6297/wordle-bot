...
import pytest
from core.domain.models import FeedbackType, GuessResult, GameState, EntropyCalculation
...
class TestGameStateManager:
    ...
    def test_consistent_filtering(self):
        ...
        guess_result = GuessResult.from_api_response("STARE", "---o-")  # Only E is present
        manager.add_guess_result(guess_result)
